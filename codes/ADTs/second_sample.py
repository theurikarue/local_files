...
class PEZDispenserGUI:
    ...
    def create_widgets(self):
        ...
        push_btn = tk.Button(button_frame, text="Push", command=self.push_tablet, bg="lime green",fg="white")
        push_btn.pack(side=tk.LEFT, expand=True)

        pop_btn = tk.Button(button_frame, text="Pop", command=self.pop_tablet, bg="orange red",fg="white",)
        pop_btn.pack(side=tk.LEFT, expand=True)

        top_btn = tk.Button(button_frame, text="Top", command=self.show_top, bg="deep sky blue",fg="white")
